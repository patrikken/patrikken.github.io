...
![](./images/Overview_web_programming-Page-2.webp){.nostretch fig-align="center" width="500"}
 

--- 

### La programmation web
![](./images/Overview_web_programming-Page-1.webp){.nostretch fig-align="center" width="1390"} 
...
- Code fortement couplé: Les scripts peu réutilisable, duplication de code.
- Difficile à maintenir: La modification de l'affichage/recherche de produits peut engendrer  des effets secondaires imprévus (modification du même fichier). 
- Test unitaire difficile: Il faut lire toute la page pour tester une fonctionnalité spécifique.
- Difficulté de mise à l'échelle : La complexité des fichiers augmente et rend l'application plus difficile à faire évoluer.
:::
...
### MVC: Une vue d'ensemble

![](./images/Overview_web_programming-Page-4.webp){.nostretch fig-align="center" width="800"} 
...
---
#### À la lumière de l'exemple de mise en œuvre, identifiez 3 avantages et 3 inconvénients de l'architecture MVC. {.center}